...
lyr_Kontur_2.set('fieldAliases', {'index': 'index', 'field_4': 'Elevation (m)', 'label': 'label', });
...
lyr_Kontur_6.set('fieldAliases', {'index': 'index', 'Elevation': 'Elevation (m)', 'label': 'label', });
...
lyr_Kontur_11.set('fieldAliases', {'index': 'index', 'Elevation': 'Elevation (m)', 'label': 'label', });
...
lyr_konturminor_16.set('fieldAliases', {'ID': 'ID', 'ELEV': 'Elevation (m)', 'index': 'index', 'LABEL': 'LABEL', 'index2': 'index2', 'LABEL2': 'LABEL2', });
lyr_konturmayor_17.set('fieldAliases', {'ID': 'ID', 'ELEV': 'Elevation (m)', 'index': 'index', 'LABEL': 'LABEL', 'index2': 'index2', 'LABEL2': 'LABEL2', });
...
lyr_konturminor_21.set('fieldAliases', {'fid': 'fid', 'ID': 'ID', 'ELEV': 'Elevation (m)', 'indeks': 'indeks', 'label': 'label', });
lyr_konturmayor_22.set('fieldAliases', {'fid': 'fid', 'ID': 'ID', 'ELEV': 'Elevation (m)', 'indeks': 'indeks', 'label': 'label', });
...
lyr_konturminor_26.set('fieldAliases', {'fid': 'fid', 'ID': 'ID', 'ELEV': 'Elevation (m)', 'Indeks': 'Indeks', 'LabelIndex': 'LabelIndex', });
lyr_konturmayor_27.set('fieldAliases', {'fid': 'fid', 'ID': 'ID', 'ELEV': 'Elevation (m)', 'Indeks': 'Indeks', 'LabelIndex': 'LabelIndex', });
...
lyr_konturminor_32.set('fieldAliases', {'fid': 'fid', 'ID': 'ID', 'ELEV': 'Elevation (m)', 'indeks': 'indeks', 'label': 'label', });
lyr_konturmayor_33.set('fieldAliases', {'fid': 'fid', 'ID': 'ID', 'ELEV': 'Elevation (m)', 'indeks': 'indeks', 'label': 'label', });
...
lyr_Kontur_2.set('fieldLabels', {'index': 'hidden field', 'field_4': 'inline label - visible with data', 'label': 'hidden field', });
